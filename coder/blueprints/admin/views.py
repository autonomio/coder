...
from coder.blueprints.admin.models import Dashboard
from coder.blueprints.user.decorators import role_required
from coder.blueprints.billing.decorators import handle_stripe_exceptions
...
from coder.blueprints.admin.forms import (
    SearchForm,
    BulkDeleteForm,
    UserForm,
...
def users_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        from coder.blueprints.billing.tasks import delete_users
...
def coupons_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        # Prevent circular imports.
        from coder.blueprints.billing.tasks import delete_coupons
